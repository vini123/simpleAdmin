        ...
        <el-card class="max-w-[640px] w-full relative pb-2 rounded-md box-card" :class="{'px-0 pt-20 mx-4': isMini, 'pt-8 px-12': !isMini}">
            ...
            <div v-if="way == 1" class="flex flex-col items-center mb-5">
                ...
                <div class="flex relative w-[156px] h-[156px]">
                    <div v-if="qrcode.key" class="flex justify-center items-center w-full">
                    ...
                    <div v-if="qrcode.ttl < 0" class="flex flex-col items-center justify-center w-[156px] h-[156px] absolute z-10 bg-black/75">
                        ...
                        <el-button size="small" type="primary" @click="buildQrcode">点击刷新</el-button>
                    </div>
                </div>       
            </div>

            <el-form v-if="way == 2" ref="ruleFormRef" :model="ruleForm" :rules="rules" :label-position="isMini? 'top':'left'" label-width="72px">
